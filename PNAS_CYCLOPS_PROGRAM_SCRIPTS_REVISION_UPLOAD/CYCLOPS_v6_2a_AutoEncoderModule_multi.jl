module CYCLOPS_v6_2a_AutoEncoderModule_multi
...
export CYCLOPS_Order_singlecore,CYCLOPS_Order_multicore
...
######################################################################
######################################################################
function CYCLOPS_Order_singlecore(l_outs::Integer,l_norm_seed_data::Array{Float64,2},N_trials::Integer)
    scalefactor=1;
    besterror=10E20
    bestnet=0;
    NET=0;
...
######################################################################
function CYCLOPS_Order_multicore(l_outs::Integer,l_norm_seed_data::Array{Float64,2},N_trials::Integer)
    SingleCoreN=Integer(ceil(N_trials/5))

    a1=@spawn CYCLOPS_Order_singlecore(l_outs,l_norm_seed_data,SingleCoreN)
    a2=@spawn CYCLOPS_Order_singlecore(l_outs,l_norm_seed_data,SingleCoreN)
    a3=@spawn CYCLOPS_Order_singlecore(l_outs,l_norm_seed_data,SingleCoreN)
    a4=@spawn CYCLOPS_Order_singlecore(l_outs,l_norm_seed_data,SingleCoreN)
    a5=@spawn CYCLOPS_Order_singlecore(l_outs,l_norm_seed_data,SingleCoreN)

    estimated_phaselist1,bestnet1,global_metrics1 = fetch(a1)
    estimated_phaselist2,bestnet2,global_metrics2 = fetch(a2)
    estimated_phaselist3,bestnet3,global_metrics3 = fetch(a3)
    estimated_phaselist4,bestnet4,global_metrics4 = fetch(a4)
    estimated_phaselist5,bestnet5,global_metrics5 = fetch(a5)

    b1 =global_metrics1[1]
    b2 =global_metrics2[1]
    b3 =global_metrics3[1]
    b4 =global_metrics4[1]
    b5 =global_metrics5[1]

    total_best_ind=indmin([b1,b2,b3,b4,b5])

    if (total_best_ind==1)
        estimated_phaselist,bestnet,global_metrics=estimated_phaselist1,bestnet1,global_metrics1
    end

    if (total_best_ind==2)
        estimated_phaselist,bestnet,global_metrics=estimated_phaselist2,bestnet2,global_metrics2
    end

    if (total_best_ind==3)
        estimated_phaselist,bestnet,global_metrics=estimated_phaselist3,bestnet3,global_metrics3
    end

    if (total_best_ind==4)
        estimated_phaselist,bestnet,global_metrics=estimated_phaselist4,bestnet4,global_metrics4
    end

    if (total_best_ind==5)
        estimated_phaselist,bestnet,global_metrics=estimated_phaselist5,bestnet5,global_metrics5
    end
